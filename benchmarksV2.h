/** \file benchmarksV2.h
	\brief Defines benchmark function headers
		
This file defines the benchmark function headers, as well as the constants for Shekel's Foxholes and benchmarkFunctions, a pointer to 
the 15 benchmark functions.
*/
...
//C Values in Shekel's Foxholes
const double FOXHOLEC[30] = { 0.806,0.517,0.1,0.908,0.965,0.669,0.524,0.902,0.351,0.876,0.462,
0.491,0.463,0.741,0.352,0.869,0.813,0.811,0.0828,0.964,0.789,0.360,0.369,
0.992,0.332,0.817,0.632,0.883,0.608,0.326 };

//A Values in Shekel's Foxholes
const double FOXHOLEA[30][10] = { { 9.681,0.667,4.783,9.095,3.517,9.325,6.544,0.211,5.122,2.02 },
...
extern double (*benchmarkFunctions[NUMBENCHMARKS])(double input[], int dim);